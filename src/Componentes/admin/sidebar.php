    ...
    <nav class="sidebar-nav">
        ...
        <?php if (Roles::permiso($rol ?? '', 'usuarios', 'ver') || Roles::permiso($rol ?? '', 'permisos', 'ver') || Roles::permiso($rol ?? '', 'vehiculos', 'ver')): ?>
            ...
            <ul class="nav-list">
                ...
                <?php if (Roles::permiso($rol ?? '', 'vehiculos', 'ver')): ?>
                    <li class="nav-item">
                        <a
                            href="<?= e($urlsModulos['vehiculos']) ?>"
                            class="nav-link <?= esLinkActivo($urlsModulos['vehiculos'], $rutaActual) ? 'active' : '' ?>"
                            data-section="vehiculos">
                            <svg class="nav-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <?php if (Roles::permiso($rol ?? '', 'usuarios', 'ver')): ?>
                    <li class="nav-item">
                        <a
                            href="<?= e($urlsModulos['auditoria']) ?>"
                            class="nav-link <?= esLinkActivo($urlsModulos['auditoria'], $rutaActual) ? 'active' : '' ?>"
                            data-section="auditoria">
                            <svg class="nav-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
